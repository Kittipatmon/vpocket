        ...
        <section className={className}>
            <header>
                ...
                <p className="mt-1 text-sm text-slate-500">
                    เพื่อให้บัญชีของคุณปลอดภัยยิ่งขึ้น ควรใช้รหัสผ่านที่ยาวและสุ่มเดาได้ยาก
                </p>
            </header>
            ...
            <form onSubmit={updatePassword} className="mt-6 space-y-6">
                ...
                <div>
                    <InputLabel htmlFor="password" value="รหัสผ่านใหม่" className="font-bold text-slate-700" />
